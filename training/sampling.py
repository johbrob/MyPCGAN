...
def save_test_samples(example_dir, data_loader, audio_mel_converter, architecture, loss_func, epoch, sampling_rate, device,
                      n_samples_generated):
    ...
    with torch.no_grad():
        for i, (data, secret, label, id, _) in tqdm.tqdm(enumerate(data_loader), 'Generating Samples',
            ...
            sample = architecture.generate_sample()
